...
OscillatorParametersComponent::OscillatorParametersComponent(OscillatorParameters *oscParams)
    ...
    sawWaveLevelSlider.setRange(_oscParamsPtr->SineWaveLevel->range.start,
                                _oscParamsPtr->SineWaveLevel->range.end, 0.01);
    sawWaveLevelSlider.setValue(_oscParamsPtr->SineWaveLevel->get(), dontSendNotification);
    ...
    triWaveLevelSlider.setRange(_oscParamsPtr->SineWaveLevel->range.start,
                                _oscParamsPtr->SineWaveLevel->range.end, 0.01);
    triWaveLevelSlider.setValue(_oscParamsPtr->SineWaveLevel->get(), dontSendNotification);
    ...
    squareWaveLevelSlider.setRange(_oscParamsPtr->SineWaveLevel->range.start,
                                   _oscParamsPtr->SineWaveLevel->range.end, 0.01);
    squareWaveLevelSlider.setValue(_oscParamsPtr->SineWaveLevel->get(), dontSendNotification);
    ...
    noiseLevelSlider.setRange(_oscParamsPtr->SineWaveLevel->range.start,
                              _oscParamsPtr->SineWaveLevel->range.end, 0.01);
    noiseLevelSlider.setValue(_oscParamsPtr->SineWaveLevel->get(), dontSendNotification);
