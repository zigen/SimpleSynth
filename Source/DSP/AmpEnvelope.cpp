...
bool AmpEnvelope::isHolding() {
  if (_ampState == AMPENV_STATE::ATTACK || _ampState == AMPENV_STATE::DECAY || _ampState == AMPENV_STATE::SUSTAIN) {
    return true;
  }
...
bool AmpEnvelope::isReleasing() { return _ampState == AMPENV_STATE::RELEASE; }
